...
ifneq ($(filter $(UM_4_9_FAMILY) $(UM_4_14_FAMILY) $(UM_4_19_FAMILY) $(UM_5_4_FAMILY) $(UM_5_10_FAMILY) $(UM_5_15_FAMILY) $(UM_6_1_FAMILY) $(UM_6_1_LEGACY_FAMILY) $(UM_6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
    SOONG_CONFIG_qtidisplay_drmpp := true
endif

# Enable Gralloc4 on UM platforms that support it
ifneq ($(filter $(UM_4_14_FAMILY) $(UM_4_19_FAMILY) $(UM_4_19_LEGACY_FAMILY) $(UM_5_4_FAMILY) $(UM_5_10_FAMILY) $(UM_5_15_FAMILY) $(UM_6_1_FAMILY) $(UM_6_1_LEGACY_FAMILY) $(UM_6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
    SOONG_CONFIG_qtidisplay_gralloc4 := true
endif

# Select AR variant of A-HAL dependencies
ifneq ($(filter $(UM_5_10_FAMILY) $(UM_5_15_FAMILY) $(UM_6_1_FAMILY) $(UM_6_1_LEGACY_FAMILY) $(UM_6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter $(UM_6_1_FAMILY) $(UM_6_1_LEGACY_FAMILY) $(UM_6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(filter $(UM_5_15_FAMILY) $(UM_6_1_FAMILY) $(UM_6_1_LEGACY_FAMILY) $(UM_6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
else ifneq ($(filter $(UM_6_1_LEGACY_FAMILY),$(TARGET_BOARD_PLATFORM)),)
    QCOM_HARDWARE_VARIANT := sm6375
...
ifneq ($(filter $(QSSI_SUPPORTED_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
    ...
    ifeq ($(filter $(UM_5_10_FAMILY) $(UM_5_15_FAMILY) $(UM_6_1_FAMILY) $(UM_6_1_LEGACY_FAMILY) $(UM_6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
        PRODUCT_SOONG_NAMESPACES += \
...
ifneq ($(USE_DEVICE_SPECIFIC_DATA_IPA_CFG_MGR),true)
    ifneq ($(filter $(LEGACY_UM_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
        ...
        PRODUCT_SOONG_NAMESPACES += hardware/qcom-caf/sm6375/data-ipa-cfg-mgr
    else ifneq ($(filter $(UM_6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(BOARD_SUPPORTS_OPENSOURCE_STHAL),true)
    ifneq ($(filter $(LEGACY_UM_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
        ...
        ifneq ($(filter $(UM_5_10_FAMILY) $(UM_5_15_FAMILY) $(UM_6_1_FAMILY) $(UM_6_1_LEGACY_FAMILY),$(TARGET_BOARD_PLATFORM)),)
